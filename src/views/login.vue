        ...
        <div class="header-left-bottom">
          <div class="">
            <div class="icon1">
              ...
              <input type="email" name='email' placeholder=" Email" v-bind:class="{ 'is-invalid': emailError }" v-model="email" >
              <div class="invalid-feedback">{{emailErrMsg}}</div>
            </div>
            <div class="icon1">
              <span class="fa fa-lock"></span>
              <input type="password" name='password' placeholder=" Password" v-model="password" v-bind:class="{ 'is-invalid': passwordError }" />
            ...
            <div class="bottom">
              <button class="btn" type="submit" @click="submitForm()">Log In</button>
            </div>
          </div>	
        </div>
      </div>
